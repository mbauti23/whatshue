...
public class SeekArc extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        int realRight = viewRight;
        int realTop = getPaddingTop();


        int[] mColorSeeds = new int[]{Color.parseColor("#343434"), Color.parseColor("#444444"), Color.parseColor("#565656"),
                Color.parseColor("#444444"), Color.parseColor("#343434"), Color.parseColor("#444444")};
        mArcPaint = new Paint();
        Rect mColorRect = new Rect(realLeft, realTop, realRight, realTop + 200);
        Shader gradient = new SweepGradient(0, getProgressWidth() / 2, Color.WHITE, Color.parseColor("#00f9ff"));
    ...
    private void onStartTrackingTouch() {
        if (mOnSeekArcChangeListener != null) {
            oldWidth = getProgressWidth();
            newWidth = getArcWidth();
            setArcWidth(210);
            setProgressWidth(210);
    ...
    private void onStopTrackingTouch() {
        if (mOnSeekArcChangeListener != null) {
            setProgressWidth(oldWidth);
            setArcWidth(newWidth);
